...
// SQLStore provider all functions to execute db queries and transactions
...
// It creates a transfer recod, add account entries, and udpate accounts' balance within a single database transaction
func (store *SQLStore) TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
	...
	err := store.execTx(ctx, func(q *Queries) error {
		...
		// TODO: get account => update accounts' balance
